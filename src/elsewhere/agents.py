...
def perceive(world, being: Being, event: Event, config,
    ...
    call = Call(
        ...
        user=prompts.perceive_user(
            ...
            said=world.chronicle.said_by(being.id, before=world.at),
...
def speak(world, speaker: Being, listener: Being, config,
    ...
    call = Call(
        ...
        user=prompts.speak_user(speaker, listener, when_label(world),
                                ...
                                world.chronicle.said_by(speaker.id, before=world.at)),
...
def reflect(world, being: Being, config,
    ...
    call = Call(
        ...
        user=prompts.reflect_user(being, today, older,
                                  world.chronicle.said_by(being.id, before=world.at)),
